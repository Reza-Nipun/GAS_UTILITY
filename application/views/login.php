...
<div class="wrapper">
  ...
  <div class="panel-heading">
  	  <span style="font-size: 18px; color:#690;">VTL GAS Utility Status System</span>
  </div>	
 ...
 <form role="form" class="form-horizontal"action="<?php echo base_url(); ?>admin/login/" method="post">
      ...
      <span style="font-size:10px;">Copyright © 2017 VIYELLATEXGROUP All rights reserved.</span>
