...
<body class="light_theme  fixed_header atm-spmenu-push blue_thm left_nav_hide">
<div class="wrapper">
    <!--\\\\\\\ wrapper Start \\\\\\-->
    <div class="header_bar">
        ...
        <div class="brand">
            <!--\\\\\\\ brand Start \\\\\\-->
            <div class="logo" style="display:block;">Dashboard</div>
...
<!--                        <li> <a href="javascript:void(0);"> <i class="fa fa-th-large"></i> </a> </li>-->
            ...
            <div class="top_right_bar">
                ...
                <div class="user_admin dropdown"> <a href="javascript:void(0);" data-toggle=""><img src="<?php echo base_url();?>assets/images/favicon.ico" style="background: #ffffff; border-radius: 5px;"/><span class="user_adminname">Viyellatex Limited</span> <b class=""></b> </a>
    ...
    <div class="inner">
        ...
        <div class="left_nav">
            ...
            <div class="left_nav_slidebar">
                <ul>
                    <li><a href="<?php echo base_url();?>access" target="_blank"><i class="fa fa-key"></i> Admin Panel <span class="left_nav_pointer"></span></a></li>
                    <li> <a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard"></i> Utility Report </a></li>
                    <li> <a href="<?php echo base_url();?>dashboard/utility_report_date_range"><i class="fa fa-dashboard"></i> Date Range - Report </a></li>
                </ul>
            </div>
        </div>
        <!--\\\\\\\left_nav end \\\\\\-->
