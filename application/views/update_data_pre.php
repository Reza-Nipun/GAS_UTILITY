...
<div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Update Utility Status</h1>
          <h2 class="">Update Utility Status...</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
              <li><a href="<?php echo base_url();?>">Home</a></li>
              <li class="active">Update Utility Status</li>
          </ol>
        </div>
      </div>

<form action="<?php echo base_url();?>access/update_utility_data" method="post">
         ...
         <div class="table-responsive">
                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="sample_3">
                  <thead>
                    ...
                    <tr>
                      <th class="hidden-phone center" style="width: 100px;">Gas Pressure (PSI)</th>
...
<!--                      <th class="hidden-phone center">Boiler 3<br />EGB Thermax, 3 Ton</th>-->
                  ...
                  <tbody>
                  <?php
                  $count_row = sizeof($result);

                  foreach ($result as $key => $v){ ?>
                    <tr class="gradeX center">
                      <td style="padding: 0px; width: 100px;"><?php echo $v['time'];?><input type="hidden" value="<?php echo $v['id'] ?>" name="id[]" id="id"></td>
                      <td style="padding: 0px; width: 100px;"><?php echo $v['date'];?></td>
                      <td style="padding: 0px; width: 100px;"><input type="text" style="width: 80px;" name="generator_gas_pressure[]" value="<?php echo $v['generator_gas_pressure'];?>" id="generator_gas_pressure<?php echo $key ?>" onkeyup="checkGeneratorGasPressure(<?php echo $key ?>, id);"></td>
                      <td class="hidden-phone" style="padding: 0px; width: 100px;"><input type="text" style="width: 80px;" name="gen_1[]" id="gen_1<?php echo $key ?>" value="<?php echo $v['gen_1'];?>" onkeyup="checkGenerator01(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="gen_3[]" id="gen_3<?php echo $key ?>" value="<?php echo $v['gen_3'];?>" onkeyup="checkGenerator03(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="gen_4[]" id="gen_4<?php echo $key ?>" value="<?php echo $v['gen_4'];?>" onkeyup="checkGenerator04(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="gen_2[]" id="gen_2<?php echo $key ?>" value="<?php echo $v['gen_2'];?>" onkeyup="checkGenerator02(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="border-right: 2px solid blue; padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="gen_remarks[]" id="gen_remarks<?php echo $key ?>" value="<?php echo $v['gen_remarks'];?>"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boil_steam_gas_pressure[]" id="boil_steam_gas_pressure<?php echo $key ?>" value="<?php echo $v['boil_steam_gas_pressure'];?>" onkeyup="checkBoilGasPressure(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boiler_1[]" id="boiler_1<?php echo $key ?>" value="<?php echo $v['boiler_1'];?>" onkeyup="checkBoiler01(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boiler_2[]" id="boiler_2<?php echo $key ?>" value="<?php echo $v['boiler_2'];?>" onkeyup="checkBoiler02(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boiler_3[]" id="boiler_3<?php echo $key ?>" value="<?php echo $v['boiler_3'];?>" onkeyup="checkBoiler03(<?php echo $key ?>, id);" /></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boiler_4[]" id="boiler_4<?php echo $key ?>" value="<?php echo $v['boiler_4'];?>" onkeyup="checkBoiler04(<?php echo $key ?>, id);"></td>
                      <td class="center hidden-phone" style="padding: 0px; width: 80px;"><input type="text" style="width: 80px;" name="boiler_remarks[]" id="boiler_remarks<?php echo $key ?>" value="<?php echo $v['boiler_remarks'];?>"></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
...
<script type="text/javascript">
    $( document ).ready(function() {
        var count_row = '<?php echo $count_row;?>';
        for(var i=0; i<count_row; i++){
            $("#generator_gas_pressure"+i).keyup();
            $("#boil_steam_gas_pressure"+i).keyup();
            $("#boiler_1"+i).keyup();
            $("#boiler_2"+i).keyup();
            $("#boiler_3"+i).keyup();
            $("#boiler_4"+i).keyup();
